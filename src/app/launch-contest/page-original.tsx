...
📋 {language === 'zh' ? '了解比赛细节' : 'Contest Details'}
        ...
        {/* 赛事时间线预览 */}
        <section className="py-20 px-4 bg-gradient-to-r from-gray-900/50 to-blue-900/30">
          <div className="max-w-6xl mx-auto">
            <motion.h2 
            ...
            <motion.p 
              className="text-center text-gray-300 mb-12 max-w-4xl mx-auto"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                { 
                  phase: language === 'zh' ? '开放期' : 'Open Period',
                  duration: language === 'zh' ? '赛事启动 → 截止日' : 'Launch → Deadline',
                  icon: '🚀',
                ...
                { 
                  phase: language === 'zh' ? 'Final Day' : 'Final Day',
                  duration: language === 'zh' ? '收官活动' : 'Grand Finale',
                  icon: '🏆',
                ...
                <motion.div
                  key={index}
                  className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-sm border border-gray-600/30 rounded-xl p-6 text-center tech-glow"
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <h3 className={`text-lg font-bold mb-2 bg-gradient-to-r ${item.color} bg-clip-text text-transparent`}>
                    {item.phase}
                  </h3>
            ...
            >
              <a
                ...
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-500 to-blue-600 text-white font-bold rounded-xl hover:from-green-400 hover:to-blue-500 transition-all duration-300 transform hover:scale-105"
              >
                📅 {language === 'zh' ? '查看完整时间线' : 'View Complete Timeline'}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { href: '/launch-contest/timeline', icon: '⏰', title: '赛事时间线', desc: '掌握重要时间节点' },
              ].map((item, index) => (
                <motion.a
                  key={item.href}
                  href={item.href}
